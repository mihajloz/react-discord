...
import img1 from "../../images/server1/img1.png";
      ...
      <div className="flex">
        ...
        <div>
          <div className="flex">
            ...
            {/**flag */}
            <div className="bg-[#5865f2] rounded-[3px] h-[16px] text-[8px] font-medium flex items-center px-[5px] mt-1 ml-1 tracking-wide">
              BOT
            </div>
            {/**time */}
          ...
          <div className="ml-4 mt-1 rounded-[5px]">
            <img alt="" src={img1} className="rounded-[5px] w-[400px]" />
          </div>
        </div>
      </div>
    </div>
